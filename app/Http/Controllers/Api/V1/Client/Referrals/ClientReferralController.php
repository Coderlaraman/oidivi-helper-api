...
namespace App\Http\Controllers\Api\V1\Client\Referrals;

use App\Http\Controllers\Controller;
use App\Http\Resources\Client\ClientReferralResource;
...
class ClientReferralController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        try {
            ...
            return $this->successResponse(
                ClientReferralResource::collection($referrals),
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            return $this->successResponse(
                new ClientReferralResource($referral),
    ...
    public function show(Referral $referral): JsonResponse
    {
        try {
            return $this->successResponse(
                new ClientReferralResource($referral->load(['referrer', 'referred'])),
