...
use App\Http\Requests\Client\UpdateClientUserProfileRequest;
...
class ClientUserController extends Controller
{
     ...
     *
     * @param UpdateClientUserProfileRequest $request
     * @return JsonResponse
     */
    public function updateProfile(UpdateClientUserProfileRequest $request): JsonResponse
    {
        try {
            $user = $request->user();
