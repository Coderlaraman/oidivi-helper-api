...
use App\Http\Requests\User\ServiceRequest\StoreClientServiceRequest;
use App\Http\Requests\User\ServiceRequest\UpdateClientServiceRequest;
...
class UserServiceRequestController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return $this->successResponse(UserServiceRequestResource::collection($services), 'Service requests retrieved successfully.');
    }
    ...
    public function store(StoreClientServiceRequest $request): JsonResponse
    {
        ...
        return $this->successResponse(new UserServiceRequestResource($service), 'Service published successfully.', 201);
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->successResponse(new UserServiceRequestResource($service), 'Service retrieved successfully.');
    }
    ...
    public function update(UpdateClientServiceRequest $request, $id): JsonResponse
    {
        ...
        return $this->successResponse(new UserServiceRequestResource($service), 'Service updated successfully.');
    }
